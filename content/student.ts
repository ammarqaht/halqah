...
export const COPY = {
  ...
  scan: 'مسح بالكاميرا',
  scanPhoto: 'صوّر البطاقة أو اختر صورة',
  scanPhotoHint: 'إن لم تعمل الكاميرا — التقط صورة للمربّع ونقرأه منها.',
  scanNoCodeInPhoto: 'لم أجد كودًا في الصورة. قرّب المربّع وأعد التصوير في ضوء أفضل.',
  scanPhotoFailed: 'تعذّرت قراءة الصورة. جرّب صورة أخرى، أو اكتب الكود بيدك.',
