...
**[`SYSTEM.md`](SYSTEM.md) — ابدأ من هنا.** النظام كما هو مبنيّ وعامل اليوم: البوّابات
الثلاث، كيف تتحرّك البيانات بينها، القواعد، الأرقام الحقيقية، وأخطاء وقعت فعلًا وما يمنعها
الآن. الملفات تحته تصف ما خُطِّط له؛ هذا يصف ما يعمل.
