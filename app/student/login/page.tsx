...
/* طا-١ — بوابة الطالب.
   ...
   The frame around it — the curtain, the form on the right, the ayah on the
   left and the two doors to the other portals — is `LoginFrame`, the same one
   the supervisor and the teacher come through: «كلها تكون بيانات التسجيل في
   الجهة اليمنى والقسم الذي فيه الآية في الجهة اليسرى، والستارة تظهر لهم
   الثلاثة» (client, 18 Sep 2026). */
